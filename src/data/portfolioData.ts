...
So take my strong advice, just remember to always think twice`,
    timedLyrics: [
      { time: 0, section: 'Intro', text: '🎵 [Хөгжмийн аялгуу эхэлж байна - Intro Drum & Bass]' },
      { time: 18, section: 'Verse 1', text: 'She was more like a beauty queen from a movie scene' },
      { time: 24, section: 'Verse 1', text: 'I said don\'t mind, but what do you mean, I am the one' },
      { time: 29, section: 'Verse 1', text: 'Who will dance on the floor in the round?' },
      { time: 34, section: 'Verse 1', text: 'She said I am the one, who will dance on the floor in the round' },
      { time: 42, section: 'Verse 2', text: 'She told me her name was Billie Jean, as she caused a scene' },
      { time: 48, section: 'Verse 2', text: 'Then every head turned with eyes that dreamed of being the one' },
      { time: 54, section: 'Verse 2', text: 'Who will dance on the floor in the round' },
      { time: 61, section: 'Pre-Chorus', text: 'People always told me be careful of what you do' },
      { time: 66, section: 'Pre-Chorus', text: 'And don\'t go around breaking young girls\' hearts' },
      { time: 72, section: 'Pre-Chorus', text: 'And mother always told me be careful of who you love' },
      { time: 78, section: 'Pre-Chorus', text: 'And be careful of what you do \'cause the lie becomes the truth' },
      { time: 85, section: 'Chorus', text: 'Billie Jean is not my lover' },
      { time: 90, section: 'Chorus', text: 'She\'s just a girl who claims that I am the one' },
      { time: 96, section: 'Chorus', text: 'But the kid is not my son' },
      { time: 101, section: 'Chorus', text: 'She says I am the one, but the kid is not my son' },
      { time: 109, section: 'Verse 3', text: 'For forty days and forty nights, The law was on her side' },
      { time: 115, section: 'Verse 3', text: 'But who can stand when she\'s in demand, Her schemes and plans' },
      { time: 120, section: 'Verse 3', text: '\'Cause we danced on the floor in the round' },
      { time: 125, section: 'Verse 3', text: 'So take my strong advice, just remember to always think twice' },
      { time: 133, section: 'Pre-Chorus', text: 'She told my baby we\'d danced \'til three, then she looked at me' },
      { time: 139, section: 'Pre-Chorus', text: 'Then showed a photo my baby cried, his eyes were like mine' },
      { time: 145, section: 'Pre-Chorus', text: '\'Cause we danced on the floor in the round, baby' },
      { time: 151, section: 'Pre-Chorus', text: 'People always told me be careful of what you do' },
      { time: 157, section: 'Pre-Chorus', text: 'And don\'t go around breaking young girls\' hearts' },
      { time: 163, section: 'Chorus', text: 'Billie Jean is not my lover' },
      { time: 168, section: 'Chorus', text: 'She\'s just a girl who claims that I am the one' },
      { time: 174, section: 'Chorus', text: 'But the kid is not my son' },
      { time: 179, section: 'Chorus', text: 'She says I am the one, but the kid is not my son' },
      { time: 187, section: 'Solo & Moonwalk', text: '🎷 [Solo / Moonwalk / Dance Solo Break]' },
      { time: 220, section: 'Chorus', text: 'Billie Jean is not my lover...' },
      { time: 240, section: 'Outro', text: 'She\'s just a girl who claims that I am the one...' },
      { time: 260, section: 'Outro', text: 'No, Billie Jean is not my lover... Hoo!' }
    ]
  },
  {
    id: 'mj-2',
